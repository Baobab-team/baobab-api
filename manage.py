...
@cli.command("seed_db")
def seed_db():
    db_session.add(Category(name="Restaurant"))
    db_session.add(
        Restaurant(
            menus=[
                Menu(
    ...
    db_session.add(Business(name="Gracia Afrika",
    ...
    db_session.add(Business(name="Mama africa",
                            description="description",
                            category_id=1,
                            ))
    db_session.add(Business(name="Marmite africaine",
                            description="description",
                            category_id=1,
                            ))

    db_session.add(Category(name="Barbershop"))
    db_session.add(Business(name="La ruche",
                            description="description",
                            category_id=2,
                            ))
    db_session.add(Business(name="Famous cut",
                            description="description",
                            category_id=2,
                            ))
    db_session.add(Business(name="Rick's cut",
                            description="description",
                            category_id=2,
                            ))
    db_session.commit()
