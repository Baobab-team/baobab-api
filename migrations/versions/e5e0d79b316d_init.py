...
Revision ID: e5e0d79b316d
Revises: 
Create Date: 2020-06-27 10:35:16.444973
...
def upgrade():
    ...
    op.create_table('business_upload',
    ...
    sa.Column('business_upload_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['business_upload_id'], ['business_upload.id'], ),
